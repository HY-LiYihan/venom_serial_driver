...
| 13–16 | `angular_x` | `float32` | 底盘旋转角速度（rad/s） |
| 17–20 | `angular_y` | `float32` | 云台 pitch 角度指令（deg） |
| 21–24 | `angular_z` | `float32` | 云台 yaw 角度指令（deg） |
...
| 20–23 | `angular_y` | `float32` | 云台 pitch 角度（deg） |
| 24–27 | `angular_z` | `float32` | 云台 yaw 角度（deg） |
