...
| 41–42 | `stage_remain_time` | `uint16` | 当前阶段剩余时间（s） |
| 43 | `center_outpost_occupancy` | `uint8` | 低 2 位：0=未占领，1=己方，2=对方，3=双方 |
| 44–45 | `current_HP` | `uint16` | 机器人当前血量 |
| 46–47 | `maximum_HP` | `uint16` | 机器人血量上限 |
| 48–49 | `shooter_barrel_heat_limit` | `uint16` | 射击热量上限 |
| 50 | `power_management_output` | `uint8` | 电源输出标志（bit0=云台，bit1=底盘，bit2=射击） |
| 51–52 | `shooter_17mm_barrel_heat` | `uint16` | 17mm 发射热量 |
| 53–54 | `shooter_42mm_barrel_heat` | `uint16` | 42mm 发射热量 |
| 55 | `armor_id_and_reason` | `uint8` | 低 4 位 = 扣血装甲 ID；高 4 位 = 扣血原因（0=弹丸，1=离线，5=碰撞） |
| 56–59 | `launching_frequency` | `float32` | 弹丸发射频率（Hz） |
| 60–63 | `initial_speed` | `float32` | 弹丸初速度（m/s） |
| 64–65 | `projectile_allowance_17mm` | `uint16` | 17mm 剩余允许发弹量 |
| 66–67 | `projectile_allowance_42mm` | `uint16` | 42mm 剩余允许发弹量 |
| 68–71 | `rfid_status` | `uint32` | RFID 增益点状态位掩码（bit 0–31 对应各增益点 ID） |
